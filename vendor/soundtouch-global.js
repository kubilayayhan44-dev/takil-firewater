...
// Global window'a expose
if (typeof window !== 'undefined') {
  window.SoundTouchJS = { AbstractFifoSamplePipe, PitchShifter, RateTransposer, SimpleFilter, SoundTouch, Stretch, WebAudioBufferSource, getWebAudioNode };
}
